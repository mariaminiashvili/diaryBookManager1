...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\bakur\PycharmProjects\diaryBookManager1'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\bakur\PycharmProjects\diaryBookManager1\Scripts\deactivate.nu'
